      ...
      <div className="container">
        <div className="-mx-4 flex flex-wrap relative">
          <div className="w-full md:px-48 ">
            ...
            <div>
              <span className="absolute left-200 top-7">
                <svg
                  width="57"
                  height="65"
                  viewBox="0 0 57 65"
              ...
              <span className="absolute bottom-24 left-200">
                <svg
                  width="39"
                  height="32"
                  viewBox="0 0 39 32"
              ...
              <span className="absolute right-48 top-[140px]">
                <svg
                  width="38"
                  height="38"
                  viewBox="0 0 38 38"
              ...
              <span className="absolute right-20 top-0">
                <svg
                  width="162"
                  height="91"
                  viewBox="0 0 162 91"
