const checkIcon = (
  <svg width="8" height="6" viewBox="0 0 8 6" className="fill-current text-black">
...
const OfferList = ({
  ...
  return (
    <div className="mb-3 flex items-center">
      <span className="mr-3 flex h-[18px] w-full max-w-[18px] items-center justify-center">
        {status === "active" ? checkIcon : crossIcon}
      </span>
      <p className={`m-0 text-base font-medium  ${classText ? classText: 'text-body-color'}`}>{text}</p>
    </div>
  );
};
